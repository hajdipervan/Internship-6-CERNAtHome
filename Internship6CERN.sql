...
SELECT s.Name, s.Surname, SUM((sqrt(sw.NumberOfQuotes)/COUNT(s.Id))) FROM Scientists s
JOIN ScientistScientificWork ssw ON ssw.ScientistId=s.Id
JOIN ScientificWorks sw ON sw.Id=ssw.ScientificWorkId
...
(default, 'The finite coarse shape ', 200, '2016-10-6', 2)
